...
testing()
{
    ...
    then
      (( Good++ ))
        echo "\033[35m$Bad\033[0m/\033[34m$Good\033[0m/$COUNTER \033[34mGood\033[0m cat $t"
    else
      (( Bad++ ))
        echo "\033[35m$Bad\033[0m/\033[34m$Good\033[0m/$COUNTER \033[35mBad\033[0m cat $t"
    fi
